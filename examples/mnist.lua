...
Train a CNN classifier on MNIST using AllReduceSGD.
   ...
   --nodeIndex         (default 1)
   --numNodes          (default 1)
   --rootHost          (default '127.0.0.1')
   --rootPort          (default 8080)
   --nodeHost          (default '127.0.0.1')
   --nodePort          (default 8080)
]]
...
local tree = require 'parallel.StaticTree'(opt.nodeIndex, opt.numNodes, opt.nodeHost, opt.nodePort, opt.rootHost, opt.rootPort)
